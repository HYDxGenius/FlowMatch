...
class AlgorithmBase:
    ...
    def set_model(self):
        ...
        initialize model
        """
        # Forward PEFT flags via **kwargs; wrappers that don't use them ignore.
        extra_kwargs = {
            'use_lora': getattr(self.args, 'use_lora', False),
            'lora_dim': getattr(self.args, 'lora_dim', 16),
        }
    ...
    def set_ema_model(self):
        ...
        ema_model = self.net_builder(num_classes=self.num_classes, **extra_kwargs)
